...
export const AME_MEDICAL_FIELDS: FieldConfig[] = [
  {
...
export const AME_TRIP_CANCEL_FIELDS: FieldConfig[] = [
  {
...
export const AME_BAGGAGE_FIELDS: FieldConfig[] = [
  {
    name: 'isBaggageDelayed',
    label: 'Was your baggage delayed? / AME',
    type: 'radio',
    options: YES_NO_OPTIONS,
  },
  {
...
export const AME_RENTAL_VEHICLE_FIELDS: FieldConfig[] = [
  {
...
export const AME_EVACUATION_FIELDS: FieldConfig[] = [
  {
...
export const AME_PA_WEEKLY_FIELDS: FieldConfig[] = [
  {
...
export const AME_PS_WEEKLY_FIELDS: FieldConfig[] = [
  {
...
export const AME_OTHERS_FIELDS: FieldConfig[] = [
  {
